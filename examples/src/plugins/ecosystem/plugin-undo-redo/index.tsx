		...
		return () => (
			<Space>
				<Button
					...
					size="small"
					data-tip={`${intlNode('Undo')} ${navigator.platform.toLowerCase().includes('mac') ? 'cmd' : 'ctrl'} + z`}
				...
				<Button
					...
					size="small"
					data-tip={`${intlNode('Redo')} ${navigator.platform.toLowerCase().includes('mac') ? 'cmd' : 'ctrl'} + y`}
